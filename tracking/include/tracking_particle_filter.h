...
#define t_MIN_WEIGHT            0.02		 //0.001            
...
typedef struct{
  ...
  std::vector<geometry_msgs::PoseWithCovariance> used_candidates;
  double sum_likelihood;
  bool under_likelihood_threshold;
  ros::Time under_likelihood_threshold_time; //This variable manage how long the center of human has been under a likelihood threshold based on new candidates
  ...
  std::vector<t_Particle> particle;
}t_Human;
