...
int main(int argc, char **argv)
{
	...
	ros::init(argc, argv, "compute_likelihood_tracking");
        ros::NodeHandle n;
	...
	candidate_publisher = n.advertise<tracking::CandidateArray>("human_candidate_tracking", 10);
	all_candidate_publisher = n.advertise<tracking::CandidateArray>("all_human_candidate_tracking", 10);
