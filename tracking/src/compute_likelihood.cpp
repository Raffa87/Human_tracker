...
bool only_detection_data;
bool only_detection_data_default = true;
...
int main(int argc, char **argv)
{
	...
	ros::init(argc, argv, "compute_likelihood");
        ros::NodeHandle n;
	...
	candidate_publisher = n.advertise<tracking::CandidateArray>("human_candidate", 10);
	all_candidate_publisher = n.advertise<tracking::CandidateArray>("all_human_candidate", 10);

	std::string param_space = ros::this_node::getName();
	get_parameter(param_space, "/desired_value", &desired_value, desired_value_default);
	get_parameter(param_space, "/duration_threshold", &duration_threshold_sec, duration_threshold_sec_default);
	...
	get_parameter(param_space, "/likelihood_frame", &likelihood_frame, likelihood_frame_default);
	get_parameter(param_space, "/only_detection_data", &only_detection_data, only_detection_data_default);
